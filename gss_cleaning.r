...
raw_data <- read_csv("AAAtnGpy.csv")
...
reduced_data<- gss %>% select(sex,age,place_birth_canada)

reduced_data <- reduced_data %>%count(sex,age,place_birth_canada) %>%
  group_by(sex,age,place_birth_canada)
...
reduced_data<-reduced_data %>%
  mutate(bornin_canada=case_when(place_birth_canada=="Born in Canada"~"Yes",
                                 place_birth_canada=="Born outside Canada"~"No",
                                 place_birth_canada== NA~"Don't know"))
